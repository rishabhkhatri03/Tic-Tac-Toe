...
// A fuction to initialise the game
void initialise(char board[][SIDE], int moves[])
{
    // Initialise the random number generator so that the same configuration doesn't arises
    srand(time(NULL));
...
//A funtion that returns true if the game is over else it returns a false
